...
=======          ====================
BinaryToEbcdic           DisplayH4ctCounts           OutputThatCount
ClearH4ctBuckets         DbaseUpdate
ClearThatBlock           InitialiseOutput           RoomInThisBlock
DateStamp                SearchByDate
DbaseUpdate              Main
DisplayH4ctCounts        GetLrecsByDate
EbcdicToHex              LocRemAddr              Main
GetH4ctCounts            DbaseUpdate
GetLrecsByCode           SearchByCode
GetLrecsByDate           SearchByDate
HowManyScreens           SearchByDate
InitialiseOutput         DbaseUpdate         LrecInitialisation         Main
LocRemAddr               InitialiseOutput
LoopInitialisation       DbaseUpdate       LrecInitialisation       Main
LrecInitialisation       Main
OutputThatCount          GetLrecsByDate
PisCheck                 RotateLrecSeries
RoomInThisBlock          GetLrecsByDate
RotateLrecSeries         GetLrecsByCode
SaveThatCount            GetLrecsByCode
SearchByCode             LoopInitialisation
SearchByDate             LoopInitialisation
SendThemBlocks           Main           RoomInThisBlock
SessionCount             DbaseUpdate             LocRemAddr             LrecInitialisation
SessionToOrdinal         LoopInitialisation
`
